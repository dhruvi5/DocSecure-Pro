...
//        }
        try {
            UserPassword userPassword = objectMapper.readValue(request.getInputStream(),UserPassword.class);
            return new UserToken(userPassword.getUsername(),userPassword.getPassword());
